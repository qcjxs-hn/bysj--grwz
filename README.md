...
## **网站主体实现**:writing_hand::pray::ok_hand:
### 3.1 前台界面设计及部分代码实现
#### 3.1.1 主页界面
...
![homepage1](./rendering/homepage1.png)
###### 图 3-1 主页界面
![homepage2](./rendering/homepage2.png)
###### 图 3-2 主页界面
![homepage3](./rendering/homepage3.png)
###### 图 3-3 主页界面
手机端的访问界面如图3-4、图3-5显示：
###### ![phonehomepage1](./rendering/phonehomepage1.png) 
###### 图 3-4 主页界面                    
##### ![phonehomepage2](./rendering/phonehomepage2.png)
###### 图 3-5 主页界面

##### 3.1.2 发文界面
我们可以分享我们的有趣的故事，分享技术，还能写日志，在未来我将添加表情使用。如图3-6、图3-7、图3-8显示:
![publisharticle](./rendering/publish_article.png)
###### 图 3-6 发文界面
![publisharticle2](./rendering/publish_article2.png)
###### 图 3-7 发文界面
![publisharticle3](./rendering/publish_article3.png)
###### 图 3-8 发文界面
#### 3.1.3 阅读文章页面
文章阅读页面有点赞、评论、分享等，如图3-9、图3-10显示:
![read](./rendedring/read.png)
###### 图 3-9 阅读界面
![read2](./rendedring/read2.png)
###### 图 3-10 阅读界面
#### 3.1.4 登录界面
网站主要采用静、动相结合的方式，即静态的主画面和动态的画面相结合。静态主页内容包括登录控件信息。动态的画面使用js进行构建，操作反馈明显。
登录界面如3-11所示：
![logo](./rendedring/logo.png)
###### 图 3-11 登录信息界面
#### 3.1.5 分页一源码界面
