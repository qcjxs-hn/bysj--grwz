...
手机端的访问界面如图3-4、图3-5显示：
           ![phonehomepage1](./rendering/phonehomepage1.png) ![phonehomepage2](./rendering/phonehomepage2.png)
            图 3-4 主页界面                    图 3-5 主页界面

#### 3.1.2 发文界面
我们可以分享我们的有趣的故事，分享技术，还能写日志，在未来我将添加表情使用。如图3-6、图3-7、图3-8显示:
![publisharticle](./rendering/publisharticle.png)
图 3-6 发文界面

![publisharticle2](./rendering/publisharticle2.png)
图 3-7 发文界面
![publisharticle3](./rendering/publisharticle3.png)
图 3-8 发文界面
#### 3.1.3 阅读文章页面
